...
if uploaded_file is not None:
    ...
    if size_option == "2 x 2 inches (US / India)":
        ...
        # Guard against temporary empty/0 values during slider setup
    ...
    # Prevent values from crashing layout division
    ...
    # --- Display Layout (CRITICAL: Safely nested inside "if uploaded_file is not None") ---
    ...
    with col2:
        ...
        # Spacing optimized for 5 columns
        margin_x = 80   
        margin_y = 120  
        gap = 40        
